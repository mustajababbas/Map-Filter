...
// const icon = {
//     url: '/wp-content/uploads/2022/05/pin.png', // url
//     scaledSize: new google.maps.Size(24, 35), // scaled size
// };
    ...
    for (i = 0; i < markers1.length; i++) {
        ...
        if (marker.category == category || category.length === 0 ) {
            ...
            if(category == ''){
                ...
                markersr =  markers1.filter((res)=>{ return res.Market == category; });
            }
            ...
            // $('.paginate_button').addClass('hide-btns');
            // $('.dataTables_info').addClass('hide-btns');
      ...
      if (marker.state == state || state.length === 0 ) {
          ...
          var markersr;
            if(state == ''){
                ...
                markersr =  unsorted.filter((res)=>{ return res.State == state; });
            }
            $('#myTable').DataTable().clear().destroy();
            $('#myTable').DataTable( {
                data: markersr,
  ...
  for (i = 0; i < unsorted.length; i++) {
      ...
      if (marker.region == region || region.length === 0 ) {
          ...
          if(region == ''){
            ...
            markersr =  unsorted.filter((res)=>{ return res.Region == region; });
        }
  ...
  for (i = 0; i < unsorted.length; i++) {
    ...
    if (marker.rank == rank || rank.length === 0 ) {
        ...
        if(rank == ''){
            ...
            markersr =  unsorted.filter((res)=>{ return res.Rank == rank; });
        }
  ...
  for (i = 0; i < unsorted.length; i++) {
    ...
    if (marker.rank == "Topten" || marker.rank == "Top25" ) {
        ...
        if(rank == ''){
            ...
            markersr =  unsorted.filter((res)=>{ return res.Rank == "Topten" || res.Rank == "Top25"; });
        }
  ...
  for (i = 0; i < unsorted.length; i++) {
    ...
    if (marker.rank == "Topten" || marker.rank == "Top25" || marker.rank == "Top50" ) {
        ...
        if(rank == ''){
            ...
            markersr =  unsorted.filter((res)=>{ return res.Rank == "Topten" || res.Rank == "Top25" || res.Rank == "Top50";  });
        }
